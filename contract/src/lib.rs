...
contract! {
    ...
    impl Anytoken {
        ...
        pub(external) fn reset(&mut self) {
            *self.value = false;
        }
...
mod tests {
    ...
    fn it_works() {
        ...
        let mut contract = Anytoken::deploy_mock(1234);
    ...
    fn deployment_works() {
        ...
        let erc20 = Anytoken::deploy_mock(1234);
    ...
    fn transfer_works() {
        ...
        env::test::set_caller::<Types>(alice);
        // Deploy the contract with some `init_value`
        let mut erc20 = Anytoken::deploy_mock(1234);
